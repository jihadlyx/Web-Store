            ...
            <div class="head">
                ...
                <div class="icons">
                    ...
                    <?php
                        ...
                        // echo $path;
                        // $path = "image/employees/avate.png";
                    ?>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="box-table">
                        <table>
                            ...
                            <tbody>
                                <?php 
                                    $q = $conn->prepare("SELECT products.id, products.name, price, company, quantity, details, path, employees.name AS employee_name, type_product.name As type FROM products JOIN employees ON id_employee = employees.id JOIN type_product ON products.type_id = type_product.id WHERE id_employee = '{$_SESSION["id_employee"]}'");
                                    $q->execute();
