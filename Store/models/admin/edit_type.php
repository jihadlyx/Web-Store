            ...
            <div class="wrapper">
                <div class="box">
                    <form action="../../PHP/type_product.php" method="POST" enctype="multipart/form-data">
                        <?php
                            if(isset($_GET["id"])){
                                $sql = "SELECT * FROM type_product WHERE id = {$_GET["id"]}";
                                $q = $conn->prepare($sql);
                                $q->execute();
                        ...
                        <div class="input-box" style="display: none;">
                            <label for="txt-name">الرقم</label>
                            <input type="text" name="id" value="<?= $type->id ?>" id="txt-name" placeholder="ادخل اسم الصنف" required >
                        </div>
                        <div class="input-box">
                            <label for="txt-name">الإسم</label>
                            <input type="text" name="name" value="<?= $type->name ?>" id="txt-name" placeholder="ادخل اسم الصنف" required >
                        </div>
                        <div class="input-box">
                        ...
                        <div class="btn-submit">
                            <input type="submit" name="Update" value="إضافة">
                        </div>
                    </form>
                </div>
            </div>
