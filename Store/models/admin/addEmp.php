...
<body dir="rtl">
    <div class="page">
        ...
        <div class="content">
            ...
            <h3 class="title-main">إضافة موظف</h3>
            <div class="wrapper">
                <div class="box">
                    <form action="../../PHP/script.php" method="POST" enctype="multipart/form-data">
                        <div class="input-box">
                            <label for="txt-name">الإسم</label>
                            <input type="text" name="name" id="txt-name" placeholder="ادخل الإسم" required >
                        </div>
                        <div class="input-box">
                            <label for="username">اسم المستخدم</label>
                            <input type="text" name="username" id="username" placeholder="ادخل اسم المستخدم" required >
                        </div>
                        <div class="input-box">
                            <label for="email">البريد</label>
                            <input type="text" name="email" id="email" placeholder="ادخل البريد" required >
                        </div>
                        <div class="input-box">
                            <label for="phone">الهاتف</label>
                            <input type="text" name="phone" id="phone" placeholder="ادخل رقم الهاتف" required >
                        </div>
                        <div class="input-box">
                            <label for="password">كلمة السر</label>
                            <input type="text" name="password" id="password" placeholder="ادخل كلمة السر" required >
                        </div>
                        <div class="input-box">
                            <label for="name">النوع</label>
                            <select name="type" id="">
                                <?php 
                                    $q = $conn->prepare("SELECT * FROM type");
                                    $q->execute();
              ...
                        </div>
                        <div class="input-box ">
                            ...
                            <input type="file" name="file" id="upload-photo" accept="image/*" require>                            
