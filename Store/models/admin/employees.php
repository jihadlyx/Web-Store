...
<body dir="rtl">
    <div class="page">
        ...
        <div class="content">
            <div class="head">
                <div class="input-box">
                    <form action="table_emp.php" method="POST">
                        <input class="search" type="text" name="search" placeholder="بحث" id="">
                    </form>
                </div>
                <div class="icons">
            ...
            <div class="wrapper-two">
                ...
                <div class="content-wrapper">
                    <div class="card-header">
                        ...
                        <a href="addEmp.php">إضافة موظف</a>
                    </div>
                    <div class="box-table">
                        <table>
                            <thead>
                            ...
                            <tbody>
                            <?php 
                                    $q = $conn->prepare("SELECT employees.id, employees.name, username, email, phone, password, type.name AS type FROM employees JOIN type ON type_id = type.id ORDER BY employees.id ASC");
                                    $q->execute();
                                    ...
                                    if($result){
                                        foreach($result as $item){
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $item->phone ?></td>
                                                <td><?= $item->type ?></td>
                                                <td><a href="../../PDF/print.php?id=<?= $item->id; ?>" class="edit">طباعة</a></td>
                                                <td><a href="EditEmp.php?id=<?= $item->id; ?>" class="edit">تعديل</a></td>
                                                <td><form action="../../PHP/script.php" method="POST">
